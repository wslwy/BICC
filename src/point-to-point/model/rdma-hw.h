...
//	void cnp_received_mlx(Ptr<RdmaQueuePair> q);
	/** BiCC **/
	void cnp_received_mlx(Ptr<RdmaQueuePair> q, bool isLongLoop);
	/** BiCC **/
	...
	void CheckRateDecreaseMlx(Ptr<RdmaQueuePair> q, bool f);
	void ScheduleDecreaseRateMlx(Ptr<RdmaQueuePair> q, uint32_t delta, bool f);
